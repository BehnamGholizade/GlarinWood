...
namespace GlarinWood.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            IEmailForForgetPassword emailPassword,
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> AccountView(string returnUrl)
        {
            ...
            //Login_RegisterViewModel lrvm = new Login_RegisterViewModel();
            //lrvm.ReturnUrl = returnUrl;
            //LoginViewModel lg = new LoginViewModel();
        ...
        //public async Task<IActionResult> AccountView(Login_RegisterViewModel model,string returnUrl = null)
        //{
        //    // Clear the existing external cookie to ensure a clean login process
        //    await HttpContext.Authentication.SignOutAsync(_externalCookieScheme);
        ...
        //[HttpGet]
        //[AllowAnonymous]
        //public async Task<IActionResult> _LoginViewPartial(string returnUrl = null)
        //{
        //    // Clear the existing external cookie to ensure a clean login process
        //    await HttpContext.Authentication.SignOutAsync(_externalCookieScheme);
        ...
        //[HttpGet]
        //[AllowAnonymous]
        //public IActionResult _RegisterViewPartial(string returnUrl = null)
        //{
        //    ViewData["ReturnUrl"] = returnUrl;
        //    return PartialView();
        //}
        ...
        public async Task<IActionResult> Register(Login_RegisterViewModel register, string submitValue, string returnUrl )
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = register.RegisterVM.Email, Email = register.RegisterVM.Email };
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
             ...
             //جهت عدم تغییر توکن در مسیر حتما کد ذیل را قبل از ارسال رایانامه بنویسید
                ...
                //return View("ForgotPasswordConfirmation");
                await _EmailPassword.SendEmailForgetPasswordAsync(user.Id, model.Email, code);
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction(nameof(AccountController.ResetPasswordConfirmation), "AccountView");
            }
